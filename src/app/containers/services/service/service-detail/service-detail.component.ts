import {
    Component, OnInit, OnDestroy, ViewChild, ChangeDetectorRef, AfterViewInit, Renderer2, ElementRef, AfterViewChecked
} from '@angular/core';
...
export class ServiceDetailComponent implements OnInit, OnDestroy, AfterViewInit, AfterViewChecked {
    ...
    fixHeight() {
        setTimeout( () => {
            if (this.serviceCate && this.copyCate) {
                ...
                this.minHeight = serviceCateHeight > copyCateHeight ? `${serviceCateHeight}px` : 'auto';
