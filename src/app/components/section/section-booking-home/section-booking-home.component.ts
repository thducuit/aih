...
export class SectionBookingHomeComponent
    ...
    handleBooking() {
        this.bookingService.callBooking(
            ...
            if (this.selectedCustomerId === -1) {
                ...
                if (bookingId) {
                    this.bookingService.callUpdateBooking(this.selectedCustomerId, bookingId).subscribe((data2: any) => {
                        this.openSuccess();
                    });
                } else {
                    this.openFail();
    ...
    loadTime(doctorId, selectedDate) {
        this.bookingService.callDateBooking(doctorId, selectedDate).subscribe((data: any) => {
